...
## Creating an AOI 
Below are examples of how to create AOIs from Brazilian municipalities using`{geobr}`.
...
bozano <- subset(muni, name_muni == "Bozano") |> vect() # Rio Grande do Sul State
colina <- subset(muni, name_muni == "Colina") |> vect() # Sao Paulo State
raposa <- subset(muni, name_muni == "Raposa") |> vect() # Maranhao State
```
